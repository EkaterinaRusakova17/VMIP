...
| salt          | VARCHAR | Уникальная строка для усиления защиты пароля        |
| password_hash | VARCHAR | Зашифрованный пароль пользователя                   |
...
* Система управления базами данных: **H2 (файловая)**
* Метод подключение через **JDBC**:
